...
img_path = "C:/Users/DELL/Downloads/test_image.jpg"
...
# Load TFLite model
interpreter = tf.lite.Interpreter(model_path="plantoscope_model.tflite")
...
# Show result
print(f"Prediction: {labels[pred_index]} (Confidence: {confidence:.4f})")